...
def test_mesolite():
    ...
    ax.imshow(pks.im, norm="log", cmap="binary", origin="lower", extent=extent)
    ...
    fig.savefig(os.path.join(directory, name + "_im.pdf"), bbox_inches="tight")
    ...
    fig.savefig(os.path.join(directory, name + "_find.pdf"), bbox_inches="tight")
    fig.savefig(os.path.join(directory, name + "_find.pgf"), bbox_inches="tight")
    ...
    fig.savefig(os.path.join(directory, name + "_index.pdf"), bbox_inches="tight")
    fig.savefig(os.path.join(directory, name + "_index.pgf"), bbox_inches="tight")
    ...
    fig.savefig(os.path.join(directory, name + "_predict.pdf"), bbox_inches="tight")
    fig.savefig(os.path.join(directory, name + "_predict.pgf"), bbox_inches="tight")
    ...
    fig.savefig(os.path.join(directory, name + "_refine.pdf"), bbox_inches="tight")
    fig.savefig(os.path.join(directory, name + "_refine.pgf"), bbox_inches="tight")
    ...
    for key in peak_dict.keys():
        ...
        sigma_1, sigma_2, theta = pks.scale_ellipsoid(
            sigma_1, sigma_2, theta, p / nx, h / ny
        )
    ...
    fig.savefig(os.path.join(directory, name + "_integrate.pdf"), bbox_inches="tight")
    fig.savefig(os.path.join(directory, name + "_integrate.pgf"), bbox_inches="tight")
