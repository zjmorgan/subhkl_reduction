...
det_cal = '/SNS/MANDI/shared/calibration/2025A/MANDI_2025A.DetCal'

filename = basename.format(instrument, IPTS, instrument, run_number)

LoadEventNexus(Filename=filename, OutputWorkspace='data', NumberOfBins=1)
